...
const GamePlay = () => {
  return (
    <>
      <section id="about" className="md:pt-[74px] pt-[40px] gameplay_bgimg bg-[url(../src/assets/images/Game_Play_Bgimg.webp)] bg-no-repeat bg-cover bg-center">
        <div className="container max-w-[1140px] px-3 mx-auto">
          ...
          <hr className="!bg-[#1eadb6] h-[3px] max-w-[140px] border-t-0 sm:max-w-[200px] md:max-w-[337px] flex justify-center items-center mx-auto mt-2" />
          ...
          <div className="relative pt-[31px]">
            ...
            <a href="https://www.youtube.com/watch?v=YXaTfFRY6SQ">
              <img
                className="absolute left-[45%] sm:left-[48%] top-[45%] sm:top-[48%] cursor-pointer max-w-[40px] sm:max-w-[65px]"
                src={play_icon}
                alt=""
              />
            </a>
        ...
        <div className="container max-w-[1140px] md:pt-[90px] pt-[40px] lg:pt-[134px] md:pb-[100px] pb-[40px] lg:pb-[155px] px-3 mx-auto flex justify-between items-center max-lg:flex-wrap">
          <div className="lg:max-w-[562px]">
            ...
            <hr className="!bg-[#1eadb6] h-[3px] max-w-[140px] sm:max-w-[200px] border-t-0 md:max-w-[337px] flex justify-center items-center mt-2" />
